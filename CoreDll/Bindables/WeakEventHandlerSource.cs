...
{
    public class WeakEventHandlerSource
    {
        ...
        private class DelegateCollection : IEnumerable<WeakDelegate>
        {
            ...
            public void Add(EventHandler singleHandler)
            {
            ...
            internal void Remove(EventHandler singleHandler)
            {
            ...
            private void AddToIndex(EventHandler singleHandler, int index)
            {
                var hashCode = WeakDelegate.GetHashCode(singleHandler);
                if (_index.ContainsKey(hashCode))
