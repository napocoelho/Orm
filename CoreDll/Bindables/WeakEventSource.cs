...
namespace CoreDll.Bindables
{
        ...
        where TEventArgs : EventArgs
    {
        ...
        private DelegateCollection Handlers { get => _handlers; set => _handlers = value; }
        ...
        public void Raise(object sender, TEventArgs e)
        {
            ...
            lock (Handlers)
            {
                validHandlers = new List<StrongHandler>(Handlers.Count);
        ...
        public void Subscribe(EventHandler<TEventArgs> handler)
        {
            ...
            //this.Handlers = new DelegateCollection();
